...
from .htdemucs_i import HTDemucs_i
from .htdemucs_s import HTDemucs_s
from .htdemucs_d import HTDemucs_d
from .htdemucs_d2 import HTDemucs_d2
from .htdemucs_d3 import HTDemucs_d3
from .htdemucs_d4 import HTDemucs_d4
from .htdemucs_c import HTDemucs_c
from .htdemucs_n import HTDemucs_n
from .htdemucs_nn import HTDemucs_nn
...
def get_model(args):
    ...
    klass = {
        ...
        'htdemucs_i': HTDemucs_i,
        'htdemucs_s': HTDemucs_s,
        'htdemucs_d': HTDemucs_d,
        'htdemucs_d2': HTDemucs_d2,
        'htdemucs_d3': HTDemucs_d3,
        'htdemucs_d4': HTDemucs_d4,
        'htdemucs_c': HTDemucs_c,
        'htdemucs_n': HTDemucs_n,
        'htdemucs_nn': HTDemucs_nn,
        'htdemucs_2nn': HTDemucs_2nn,
        'htdemucs_nc': HTDemucs_nc,
...
@hydra_main(config_path="../conf", config_name="n_train", version_base="1.1")
def main(args):
    global __file__
